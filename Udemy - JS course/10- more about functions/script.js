...
// */
// const poll = {
//   qestion: "What is your favourite programming language?",
...
// in js we can make functions to that can only run once, on the same line they are created 
// // we do this by wrapping the anonymous function in a paraenthesis which converts the funciton into a expression
// (()=>{console.log('this arrow function can be called or run again')})();
// (()=>{console.log('this arrow function can be called or run again')})()
// // (function(){console.log('this function statement can be called or run again')})()
